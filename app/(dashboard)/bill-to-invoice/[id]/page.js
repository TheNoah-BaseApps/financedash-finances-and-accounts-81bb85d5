...
export default function EditBillToInvoicePage({ params }) {
  ...
  async function fetchInvoice() {
    try {
      const response = await fetch(`/api/bill-to-invoice/${params.id}`);
      ...
      if (data.success) {
        ...
        setFormData({
          ...
          unit_price: invoice.unit_price.toString(),
          amount: invoice.amount.toString(),
          tax_percentage: invoice.tax_percentage.toString(),
